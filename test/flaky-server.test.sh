...
test_bad_routes_never_fall_back_to_delay() {
    local path
    for path in /delay /delay/no /delay/-1 /delay/1.5 /delay/2147483648 /delay/999999999999999999999 /drop/1/2 /status/100 /status/600 /status/abc /reset/50 /trickle/no; do
        request "$path"
...
test_head_never_sends_a_body() {
    local path
    for path in /delay/0 /drop/0 /trickle/100 /status/503; do
        request "$path" HEAD
