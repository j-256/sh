...
UNDER_TEST="$SCRIPT_DIR/../scripts/bak"
...
test_file_not_exists() {
    ...
    assert_stderr_contains "error message" "[ERR][bak] $TEST_DIR/files/nonexistent: No such file"
}
...
test_unknown_option() {
    ...
    assert_stderr_contains "unknown argument" "[ERR][bak] Unknown argument '--invalid'"
}
...
test_backup_only_exists() {
    ...
    assert_stderr_contains "error message" "[ERR][bak] $TEST_DIR/files/only: No such file"
}
